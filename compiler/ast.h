...
typedef enum {
    ...
    NODE_STATIC_VAR, /* static type name = expr; top-level mutable global */
    NODE_STRUCT_LITERAL, /* ClassName { field: value, ... } stack-allocated struct */
    NODE_MODULE,      /* module Name { ... } */
} NodeType;
...
typedef struct {
    ...
    ASTNode **body;
    int body_count;
    int is_naked; /* 1 = naked function (no prologue/epilogue) */
} MethodNode;
...
typedef struct {
    ...
    int body_count;
    int is_naked;       /* 1 = naked function (no prologue/epilogue) */
    int is_public;      /* 1 = public module member, 0 = private */
    char *module_name;  /* set when inside a module, NULL otherwise */
} FuncNode;
...
typedef struct {
    ...
    ASTNode *operand;
    int postfix;
    int is_volatile; /* 1 if this deref is a volatile read */
} UnaryOpNode;
...
typedef struct {
    ...
    char *name;
    int is_public;
    int is_packed; /* 1 = packed class (no alignment padding) */
    int is_union;  /* 1 = union class (all fields share offset 0, size = max field size) */
    FieldNode **fields;
    int field_count;
    MethodNode **methods;
    int method_count;
...
typedef struct {
    ASTNode base;
    char *name;              /* e.g. "Pmm" */
    FuncNode **funcs;        /* all functions (public and private) */
    int func_count;
    int *func_is_public;     /* parallel array: 1=public, 0=private */
    StaticVarNode **statics; /* static vars inside the module */
    int static_count;
} ModuleNode;

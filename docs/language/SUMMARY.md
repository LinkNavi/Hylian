...
- [Syntax](language/syntax.md)
  - Types, variables, functions, classes, enums, switch, pointers, unsafe, const, static arrays, bitwise ops, struct literals, `as` casts, `null`, digit separators, `union class`, and more

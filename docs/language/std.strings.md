...
> **Memory note:** Functions marked *heap-allocated* return a newly allocated string. The caller is responsible for freeing it. This will be handled automatically by a future garbage collector.

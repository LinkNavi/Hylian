...
echo -e "${BOLD}${CYAN}║      Hylian LSP Build System         ║${RESET}"
echo -e "${BOLD}${CYAN}╚══════════════════════════════════════╝${RESET}"
echo ""
...
if [[ $CLEAN -eq 1 ]]; then
  ...
  run rm -f hylian-lsp
  run rm -f src/parser_lsp.tab.c src/parser_lsp.tab.h src/lex_lsp.yy.c
...
echo -e "${GREEN}${BOLD}╚══════════════════════════════════════╝${RESET}"
echo ""
echo -e "  Binary:  ${BOLD}$(pwd)/hylian-lsp${RESET}"
echo -e "  Install: ${DIM}sudo cp $(pwd)/hylian-lsp /usr/local/bin/${RESET}"
echo ""
